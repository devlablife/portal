...
export function PlayStoreLink({ color = 'black', link }) {
  return (
    <Link
      href={link}
    ...
    >
      <svg
        ...
        className='h-10'
        viewBox="-449.849 -222.507 3898.693 1335.042"
      >
        <defs>
          <linearGradient id="a" y2={0.278} x2={0.26} y1={0.956} x1={0.613}>
          ...
          <linearGradient id="b" y2={0.509} x2={-1.305} y1={0.509} x1={1.076}>
            <stop offset="0%" stopColor="#FFE000" />
            <stop offset="40.87%" stopColor="#FFBD00" />
            <stop offset="77.54%" stopColor="orange" />
            <stop offset="100%" stopColor="#FF9C00" />
          </linearGradient>
          <linearGradient id="c" y2={-0.361} x2={-0.505} y1={0.691} x1={0.867}>
            <stop offset="0%" stopColor="#FF3A44" />
            <stop offset="100%" stopColor="#C31162" />
          </linearGradient>
          <linearGradient id="d" y2={0.649} x2={0.418} y1={1.119} x1={-0.193}>
          ...
          <linearGradient id="e" y2={-0.021} x2={-0.501} y1={0.695} x1={0.862}>
            <stop offset="0%" stopColor="#CC2E36" />
            <stop offset="100%" stopColor="#9C0E4E" />
          </linearGradient>
          <linearGradient id="f" y2={4.496} x2={-0.663} y1={15.318} x1={3.073}>
          ...
          <linearGradient id="i" y2={-10.098} x2={-0.657} y1={0.234} x1={3.061}>
          ...
          <linearGradient id="j" y2={0.537} x2={0.421} y1={0.856} x1={-0.188}>
        ...
        <g fill="none">
          ...
          />
          <path
            d="m12.047.234-1.651 1.582C3.932 8.666.115 19.305.115 33.08v-3.242 492.088-3.25c0 14.916 4.45 26.153 11.905 32.89l275.237-275.675L12.047.234"
            fill="url(#k)"
            transform="matrix(1 0 0 -1 221.426 720.923)"
          />
          <path
            d="M92.444.738.686 92.66l91.75 91.907 110.769-63.032c14.066-8.006 21.963-18.323 23.283-28.866v-.042c-1.32-10.518-9.217-20.845-23.283-28.848L92.445.739"
            fill="url(#l)"
          ...
          />
          <path
            d="M275.428.707.19 276.382c5.232 4.72 11.932 7.223 19.611 7.223 7.533 0 15.993-2.407 24.932-7.483L367.177 92.614 275.427.707"
            fill="url(#n)"
            transform="matrix(1 0 0 -1 233.255 445.74)"
          />
          <path
            d="M22.077.861c-7.688 0-14.406 2.512-19.638 7.24l-.009-.008a.635.635 0 0 1-.069.06L.93 9.553c-.045.044-.087.095-.14.146l1.65 1.653c5.232-4.728 11.94-7.24 19.63-7.231 7.512 0 15.965 2.398 24.886 7.465l322.452 183.508 2.066-2.07-2.092-1.19L46.955 8.336C38.825 3.72 31.092 1.313 24.107.912a41.848 41.848 0 0 0-2.03-.05"
            fill="url(#o)"
          ...
          />
          <path
            d="M2.708.169.642 2.239l110.76 63.04c14.067 8.003 21.964 18.33 23.284 28.848 0-3.86-.86-7.719-2.568-11.475-3.446-7.57-10.352-14.723-20.715-20.624L2.708.168"
            fill="url(#q)"
          ...
          />
          <path
            d="M369.398.66 46.955 184.17c-8.939 5.075-17.398 7.482-24.931 7.482-7.68 0-14.38-2.503-19.611-7.223l-1.624 1.634a29.747 29.747 0 0 0 1.58 1.555c.017.018.044.036.061.053 5.19 4.684 11.819 7.187 19.43 7.232h.164c7.533 0 15.992-2.408 24.931-7.485L371.473 2.737l-.009-.007-2.066-2.07"
            fill="url(#t)"
